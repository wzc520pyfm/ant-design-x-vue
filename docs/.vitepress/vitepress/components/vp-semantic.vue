...
.semantic-container {
  ...
  .marker {
    ...
    pointer-events: none;
    inset-inline-start: calc(v-bind('markPos[0] + "px"') - v-bind('MARK_BORDER_SIZE + "px"'));
    top: calc(v-bind('markPos[1] + "px"') - v-bind('MARK_BORDER_SIZE + "px"'));
    width: calc(v-bind('markPos[2] + "px"') + calc(v-bind('MARK_BORDER_SIZE + "px"') * 2));
    height: calc(v-bind('markPos[3] + "px"') + calc(v-bind('MARK_BORDER_SIZE + "px"') * 2));
  };
